...
void IO_Init(void) {
    ...
    IO.POT_FWD.DebounceTimerCounter = 0;
    IO.POT_FWD.DebounceTimerProg = 7; //x16.67ms, al menos ~10Hz
    ...
    IO.POT_RWD.DebounceTimerCounter = 0;
    IO.POT_RWD.DebounceTimerProg = 7; //x16.67ms, al menos ~10Hz
    ...
    IO.POT_CSL.DebounceTimerCounter = 0;
    IO.POT_CSL.DebounceTimerProg = 7; //x16.67ms, al menos ~10Hz
    ...
    IO.POT_INST.DebounceTimerCounter = 0;
    IO.POT_INST.DebounceTimerProg = 7; //x16.67ms, al menos ~10Hz
}
